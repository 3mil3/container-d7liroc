...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-d7liroc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-d7liroc.containers.anotherwebservice.com/
...
```
git clone git@github.com:3mil3/container-d7liroc.git
cd container-d7liroc
```
...
```
docker attach container-d7liroc
```
